...
const vcard = 'BEGIN:VCARD\n'
  ...
  + 'FN: ᴾ͢ᵃᵗᵒ𐇯¿?͓\n' // Nama
  + 'ORG:ᴾ͢ᵃᵗᵒ𐇯¿?͓;\n' // Nama bot
  + 'TEL;type=CELL;type=VOICE;waid=687533389:+687 53.33.89n' // Nomor bot
  + 'END:VCARD' 
//Banned Call
...
pato.sendMessage(from, slott, text, {quoted: mek})
break

case prefix+ 'ship':
if (!isGroup) return reply(ptbr.group())
const ag = await pato.getgroupMetadata.participants(from)
...
pato.sendMessage(from, casal, text, {quoted: mek, contextInfo: {"mentionedJid": [ag]}})
break
