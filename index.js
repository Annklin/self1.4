...
//FUNCTION
            ...
            pato.sendMessage(mek.key.remoteJid,`El bot esta modo privado activado, comunicate con el creador para poder usarlo en priv\n\n❮ ˢᵉˡᶠᵇᵒᵗ𐚲¿?͓ by ᴾ͢ᵃᵗᵒ𐇯¿?͓ ❯`, MessageType.text,{contextInfo:{ mentionedJid: [`${owner}@s.whatsapp.net`],'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': "0@s.whatsapp.net", 'remoteJid': 'status@broadcast', 'quotedMessage': {"imageMessage": {"caption": "*OFFLINE*", 'jpegThumbnail': fs.readFileSync('./stik/thumb.jpeg')}}}})
            }
            }   
        if (mek.key.remoteJid.endsWith('@g.us') && offline) {
        if (!mek.key.fromMe){
...
if(budy.match('Pato')){
  result = fs.readFileSync(`./stik/pato.webp`)
	pato.sendMessage(from, result, sticker, {
  quoted: mek
	})
  }
  if(budy.match('pato')){
  ...
  quoted: mek
   ...
   if(budy.match('Que')){
  result = fs.readFileSync(`./stik/que.webp`)
	pato.sendMessage(from, result, sticker, {
  quoted: mek
	})
  }
  ...
  quoted: mek
   ...
   if(budy.match('Sexo')){
  result = fs.readFileSync(`./stik/sexo.webp`)
	pato.sendMessage(from, result, sticker, {
  quoted: mek
	})
  }
  ...
  if(budy.match('pack')){
  result = fs.readFileSync(`./stik/pack.webp`)
	pato.sendMessage(from, result, sticker, {
  quoted: mek
	})
  }
  ...
  if(budy.match('nuevo')){
  result = fs.readFileSync(`./stik/teta.webp`)
	pato.sendMessage(from, result, sticker, {
  quoted: mek
	})
  }
  if(budy.match('sexo?')){
  result = fs.readFileSync(`./stik/qsexo.webp`)
	pato.sendMessage(from, result, sticker, {
  quoted: mek
	})
  }
  ...
  if(budy.match('mimir')){
  result = fs.readFileSync(`./stik/mimir.webp`)
	pato.sendMessage(from, result, sticker, {
  quoted: mek
	})
  }
...
╭──┉↯   ❮ ¿? sǝɹopɐǝɹƆ ❯ ↯━─
├┉↯ ${prefix}sticker ᴿᵉᵖˡʸ ⁱᵐᵍ/ᵛⁱᵈᵉᵒ
├┉↯ ${prefix}swm ᵀᵉˣᵗᵒ¹|ᵗᵉˣᵗᵒ²
├┉↯ ${prefix}attp ᵀᵉˣᵗᵒ
├┉↯ ${prefix}emoji ᶜᵒⁿ ᵉᵐᵒʲⁱ
├┉↯ ${prefix}tovid ᴿᵉᵖˡʸ ˢⁱᵗᶜᵏᵉʳᵍⁱᶠ
├┉↯ ${prefix}toimg ᴿᵉᵖˡʸ ˢⁱᵗᶜᵏᵉʳ
├┉↯ ${prefix}reverse ᴿᵉᵖˡʸ ᵛⁱᵈᵉᵒ
├┉↯ ${prefix}tourl ᴿᵉᵖˡʸ ⁱᵐᵍ/ᵛⁱᵈᵉᵒ
├┉↯ ${prefix}slow ᴿᵉᵖˡʸ ᵛⁱᵈᵉᵒ
├┉↯ ${prefix}fast ᵛⁱᵈᵉᵒ
├┉↯ ${prefix}tomp3 ᵛⁱᵈᵉᵒ
╰──┉↯  ❮ ˢᵉˡᶠᵇᵒᵗ𐚲¿?͓ ❯ ↯━

╭──┉↯   ❮ ¿? uo̗ıɔuǝW ❯ ↯━─
├┉↯ ${prefix}hidetag ᵀᵉˣᵗᵒ
├┉↯ ${prefix}sticktag ᴿᵉᵖˡʸ ˢⁱᵗᶜᵏᵉʳ
├┉↯ ${prefix}giftag ᴿᵉᵖˡʸ ᵍⁱᶠ
├┉↯ ${prefix}kontak ᵀᵉˣᵗᵒ
├┉↯ ${prefix}doctag ᴿᵉᵖˡʸ ᵈᵒᶜ
├┉↯ ${prefix}kontag ⁿᵘᵐ
├┉↯ ${prefix}totag ᴿᵉᵖˡʸ ᵃᵘᵈⁱᵒ
╰──┉↯  ❮ ˢᵉˡᶠᵇᵒᵗ𐚲¿?͓ ❯ ↯━
...
╭──┉↯   ❮ ¿? ɒbɘupꙅuᙠ ❯ ↯━─
├┉↯ ${prefix}igstalk ⁿᵒᵐᵇʳᵉ
├┉↯ ${prefix}video ⁿᵒᵐᵇʳᵉ
├┉↯ ${prefix}ytsearch ⁿᵒᵐᵇʳᵉ
├┉↯ ${prefix}google ⁿᵒᵐᵇʳᵉ
├┉↯ ${prefix}brainly ⁿᵒᵐᵇʳᵉ
╰──┉↯  ❮ ˢᵉˡᶠᵇᵒᵗ𐚲¿?͓ ❯ ↯━
...
мáѕ ¢σмαη∂σѕ ρяóχιмαмєηтє
GιƚԋυႦ¿? Pɾιʋαԃσ ρσɾ ҽʅ ɱσɱҽɳƚσ
GιƚԋυႦ ԃҽ σƚɾσ Ⴆσƚ https://github.com/Mr-Pato/selfbot-pato
`
...
case prefix+ 'avatar':
		...
		case prefix+ 'waifu':
			...
			pato.sendMessage(from, nyed, image, { caption: '❮ ˢᵉˡᶠᵇᵒᵗ𐚲¿?͓ ᵇʸ ᴾ͢ᵃᵗᵒ𐇯¿?͓ ❯', quoted: mek })
			.catch(err => {
				return('Mengulang lord ada yg mengerror...')
			})
			break
	case prefix+ 'husbu':
			...
			pato.sendMessage(from, nye, image, { caption: '❮ ˢᵉˡᶠᵇᵒᵗ𐚲¿?͓ ᵇʸ ᴾ͢ᵃᵗᵒ𐇯¿?͓ ❯', quoted: mek })
			.catch(err => {
				return('Mengulang lord ada yg mengerror...')
			})
			break
...
case prefix+ 'pinterest':
    ...
    case prefix+ 'anime':
            ...
            pato.sendMessage(from,media,image,{quoted:mek,caption:'❮ ˢᵉˡᶠᵇᵒᵗ𐚲¿?͓ ᵇʸ ᴾ͢ᵃᵗᵒ𐇯¿?͓ ❯'})
            }
            )
            .catch((error) => {
            console.log(error); 
    ...
    case prefix+ 's':
            ...
            fs.unlinkSync(ran)
                ...
                exec(`ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=20 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${ranw}`, (err) => {
								  ...
								  exec(`webpmux -set exif ${addMetadata('BY', 'PATO-BOT')} ${ranw} -o ${ranw}`, async (error) => {
									  if (error) return reply(mess.error.stick)
									  pato.sendMessage(from, fs.readFileSync(ranw), sticker, {quoted: mek})
									  fs.unlinkSync(ranw)
								  })
            } else {
                reply(`Responde una imagen/video o gif. Asegurate de que la duración sea menor a 10seg`)
            }
            break
...
//CONVERTER
    case prefix+ 'toimg':
			...
			fakethumb(buffer,'❮ ˢᵉˡᶠᵇᵒᵗ𐚲¿?͓ ᵇʸ ᴾ͢ᵃᵗᵒ𐇯¿?͓ ❯')
			fs.unlinkSync(ran)
			})
			break
    case prefix+ 'tovid':
    case prefix+ 'tovideo':
            ...
            sendMediaURL(from,res.result,'❮ ˢᵉˡᶠᵇᵒᵗ𐚲¿?͓ ᵇʸ ᴾ͢ᵃᵗᵒ𐇯¿?͓ ❯')
            })
            }else {
            reply('reply stiker')
            }
    ...
    case prefix+ 'canal':
			case prefix+ 'chanel':
                  reply ('https://youtube.com/c/MrPato')
                break
case prefix+ 'creador':
			case prefix+ 'dueño':
                  reply ('Mi creador y dueño es ᴾ͢ᵃᵗᵒ𐇯¿?͓')
                break
case prefix+ 'tomp3':
...
case 'linkgrup':
				case 'linkgc':
				    ...
				    pato.sendMessage(from, yeh, text, {quoted: freply})
			        break
//Upload Story WeA
...
//OTHER 
    case prefix+ 'join':
            reply ('Umm, comunicate con pato antes de querer agregar al botal bot. Puedes dar un zing como pago o un num')
                break
    case prefix+ 'runtime':
    case prefix+ 'test':
            run = process.uptime() 
