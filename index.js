...
.group)
        ...
        pato.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
		if (budy.includes("bot")){
		pato.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/yawey.mp3')
        ...
        if (budy.includes("A")){
		pato.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/agrito.mp3')
        pato.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
